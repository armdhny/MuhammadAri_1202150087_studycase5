...
import com.example.ari.muhammadari_1202150087_studycase5.data.adapter.Adapter;
import com.example.ari.muhammadari_1202150087_studycase5.data.database.Database;

import java.util.ArrayList;

public class ListKerjaan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_list_kerjaan);//set title menjadi To Do List
        setTitle("To Do List");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id==R.id.action_settings){
            ...
            Intent intent = new Intent(ListKerjaan.this, pengaturan.class);
            //memulai intent
    ...
    public void add(View view) {
        ...
        Intent intent = new Intent(ListKerjaan.this, ToDo_Act.class);
        //memulai intent
        startActivity(intent);
    }
}
